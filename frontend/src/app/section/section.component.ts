...
export class SectionComponent {
  ...
  public constructor(private mangaService:MangaService,private route: ActivatedRoute, private location: Location) {
  ...
  getCharacterManga(malId: number): void {
    this.mangaService.getCharacterManga(malId).subscribe(
      (data: any) => {
